//main app container, which includes the filter and user
var React = require('react');
var FilterContainer = require('./filterContainer.jsx');
var User = require('./User.jsx');

//responsible for keeping the state of user, city, and topic
    //if we wanted to include date of meetup we would use this as well
